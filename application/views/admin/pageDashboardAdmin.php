                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">1280</span></div>
                                            <div class="stat-heading">Proyek Sukses</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">1052</span></div>
                                            <div class="stat-heading">Total Sponsor</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">$<span class="count">280m</span></div>
                                            <div class="stat-heading">Total Terdonasi</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">3298</span></div>
                                            <div class="stat-heading">Total Sukarelawan</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <i class="mr-2 fa fa-handshake-o"></i>
                                    <strong class="card-title" v-if="headerText"> Ikutaja Hari Ini!</strong>
                                </div>

                                <div class="card-body">

                                <div class="typo-headers">                                    
                                    <h2 class="pb-2">Selamat Datang Kembali Admin</h2>                                    
                                </div>
