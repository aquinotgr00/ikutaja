        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 center">
                <div class="about-img-area img-full">
                    <div class="img-title">
                        <h2>Ikutaja</h2>
                        <img draggable="false" src="https://res.cloudinary.com/ikutaja/image/upload/v1546492336/img/about/team.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6 offset-md-3 center pt-30 pb-50">
                <div class="section-title">
                    <a class="default-btn" href="<?php echo base_url('teams');?>">Kenali Tim Ikutaja</a>
                </div>
            </div>
        </div>
    </div>
