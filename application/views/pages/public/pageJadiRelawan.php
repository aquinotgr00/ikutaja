                    ...
                    <div class="volunteer-form">
                            ...
                            <div class="row pb-30">
                                <div class="col-lg-3 col-md-6">
                                    <div class="volunteer-form-style mb-20">
                                        <input name="name" placeholder="Nama Depan" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="volunteer-form-style mb-20">
                                        <input name="name" placeholder="Nama Belakang" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="volunteer-form-style mb-20">
                                        <input name="email" placeholder="Alamat Email" type="email">
                                    </div>
                                </div>                                
                                <div class="col-lg-6">
                                    <div class="volunteer-form-style mb-20">
                        ...
                        <form action="#">
                            <div class="row pb-30">    
                                ...
                                <div class="col-lg-6">
                                    <div class="volunteer-form-style mb-20">
                                        <input name="profesi" placeholder="Profesi" type="text">
                                    </div>
                                </div>
