...
<h1 class="breadmome-name">Team</h1>
<ul>
...
<h3 class="member-name"><a href="<?php echo base_url('teamDetail');?>">Aquino Tegar</a></h3>
...
<div class="volunteer-content">
<h3 class="member-name"><a href="<?php echo base_url('teamDetail');?>">Samsaraji Deyanbunayya</a></h3>
...
<div class="volunteer-content">
<h3 class="member-name"><a href="<?php echo base_url('teamDetail');?>">Hilmi Afifi Al-Atsari</a></h3>
...
<div class="volunteer-content">
<h3 class="member-name"><a href="<?php echo base_url('teamDetail');?>">Rizal Hanif Amrulloh</a></h3>
