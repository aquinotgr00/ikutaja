        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url('admin/dashboard'); ?>"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
                    </li>

                    <li class="menu-title">Kelola Volunteer</li><!-- /.menu-title -->
                        <li>
                            <a href="<?php echo base_url('admin/accountVolunteer'); ?>"> <i class="menu-icon fa fa-user"></i>Account</a>                                                                                                                                                         
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/eventVolunteer'); ?>"> <i class="menu-icon fa fa-wheelchair"></i>Events</a>                                                                                                                                                         
                        </li>

                    <li class="menu-title">Kelola Organizer</li><!-- /.menu-title -->
                        <li>
                            <a href="<?php echo base_url('admin/accountOrganizer'); ?>"> <i class="menu-icon fa fa-users"></i>Account</a>                                                                                                                                                         
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/eventOrganizer'); ?>"> <i class="menu-icon fa fa-wheelchair-alt"></i>Events</a>                                                                                                                                                         
                        </li>
